...
use MindscapeTheme\SiteLeadsThemeKit\SiteLeads;
...
<div class="mindscape-admin-big-notice--container">
    <div class="logo-holder">
        <h2><?php echo sprintf(__("Choose one of the %s predefined designs to start with:", 'mindscape'), ucfirst(get_stylesheet())); ?></h2>
    </div>
    <div class="content-holder">
        <ul class="predefined-front-pages">
            ...
            foreach ( $front_page_designs as $mindscape_design_index => $design ) : ?>
				<?php
				$mindscape_design_selected = $mindscape_design_index === 0 ? 'selected' : '';
                ...
                <li data-index="<?php echo esc_attr( $design['index'] ); ?>"
                    class="<?php echo $mindscape_design_selected; ?>">
                    ...
                    <div class="predefined-front-page-card">
                        ...
                        <div class="front-page-design-wrapper">
                            <div class="design-preview-image"
                                 style="background-image: url(<?php echo esc_attr( mindscape_theme()->getAssetsManager()->getBaseURL() . "/images/{$preview_image_name}" ); ?>)"
                            ></div>
                        </div>
