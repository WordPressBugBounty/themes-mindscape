...
add_action('after_setup_theme', function() {
    mindscape_theme()->register_menus(
        array(
...
add_filter( 'kubio/activation/after_activation_redirect_url', 'mindscape_after_activation_redirect_url' );
function mindscape_after_activation_redirect_url( $url ) {
