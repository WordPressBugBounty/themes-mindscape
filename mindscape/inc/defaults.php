<?php
$mindscape_theme_svg_icons = array(
	'fort-awesome'  => array(
...
$mindscape_theme_divider_style = array(
...
return array(
	'default_icon'                 => $mindscape_theme_svg_icons['fort-awesome'],
	'icons'                        => $mindscape_theme_svg_icons,
	'divider_style'                => $mindscape_theme_divider_style,
	'lorem_ipsum'                  => $mindscape_lorem_ipsum,
	'edit_this_text_in_customizer' => $mindscape_theme_click_pen_to_edit_title,
	'gradients'                    => $mindscape_gradients,
	...
	'front-header' => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $mindscape_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $mindscape_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value' => $mindscape_theme_click_pen_to_edit_title,
			'style' => array(
				'descendants' => array(
					'text' => array(
						'textAlign' => 'center',
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $mindscape_gradients['front_header_default_overlay'],
									'gradient_opacity' => 50,
									'shape'            =>
										array(
											'value'  => 'none',
							...
							'slideshow' => array(
								...
								'slides'   => array(
									array(
										'url' => get_template_directory_uri() . '/resources/images/slide1.jpg',
									),
									array(
										'url' => get_template_directory_uri() . '/resources/images/slide2.jpg',
									),
									array(
										'url' => get_template_directory_uri() . '/resources/images/slide3.jpg',
									),
								),
							),
							'video'     => array(
							...
							'image'     => array(
								array(
									'source'     => array(
										...
										'gradient' => $mindscape_gradients['night_fade'],
									),
									'attachment' => 'scroll',
								),
							),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $mindscape_theme_svg_icons['facebook-square'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $mindscape_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $mindscape_theme_svg_icons['youtube-play'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $mindscape_theme_svg_icons['yahoo-square'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $mindscape_theme_svg_icons['map-marker'],
						'text'       => 'Location, State, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $mindscape_theme_svg_icons['phone'],
						'text'       => '(000) 123 12345',
						'link_value' => 'tel:+400 098 765 432',
						'index'      => 1,
					),
					array(
						'icon'       => $mindscape_theme_svg_icons['envelope'],
	...
	'header'                            => array(
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $mindscape_gradients['inner_header_default_overlay'],
									'gradient_opacity' => 40,
									'shape'            =>
										array(
											'value'  => 'none',
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					array(
						'icon'       => $mindscape_theme_svg_icons['facebook'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
					...
					array(
						'icon'       => $mindscape_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $mindscape_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $mindscape_theme_svg_icons['phone-square'],
